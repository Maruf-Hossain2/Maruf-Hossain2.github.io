...
document.addEventListener('mousemove', (e) => {
    ...
    neonCursor.classList.add('smooth'); // Add smooth class for a quick transition
});

document.addEventListener('mouseleave', () => {
    neonCursor.style.display = 'none'; // Hide cursor when mouse leaves
});

document.addEventListener('mouseenter', () => {
    neonCursor.style.display = 'block'; // Show cursor when mouse enters
});

// Function to update neon cursor position
...
document.addEventListener('mousemove', (e) => {
    ...
    updateCursorPosition(e.pageX, e.pageY); // Update cursor position
});
